...
a1 = get(handles.P1x,'String');
p1x = str2double(a1);
a2 = get(handles.P2x,'String');
p2x = str2double(a2);
a3 = get(handles.P3x,'String');
p3x = str2double(a3);
a4 = get(handles.P1y,'String');
p1y = str2double(a4);
a5 = get(handles.P2y,'String');
p2y = str2double(a5);
a6 = get(handles.P3y,'String');
p3y = str2double(a6);
a7 = get(handles.P1z,'String');
p1z = str2double(a7);
a8 = get(handles.P2z,'String');
p2z = str2double(a5);
a6 = get(handles.P3y,'String');
p3z = str2double(a6);
a7 = get(handles.It,'String');
it = str2double(a7);
f = true;
currentX = 0;
currentY = 0;
